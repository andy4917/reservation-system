...
# Backward-compatible aliases for legacy Python entrypoints.
DEFAULT_NAVER_BUSINESS_ID = POLICY_NAVER_BUSINESS_ID
DEFAULT_STATION_BRANCH_ID = POLICY_STATION_BRANCH_ID
DEFAULT_NAVER_ROOM_IDS = POLICY_NAVER_ROOM_IDS
DEFAULT_STATION_ROOM_IDS = POLICY_STATION_ROOM_IDS
DEFAULT_STATION_API_BASE = POLICY_STATION_API_BASE
DEFAULT_NAVER_API_BASE = POLICY_NAVER_API_BASE
