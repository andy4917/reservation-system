(() => {
  ...
  const TEXT = {
    ...
    syncProviderApply: "현재 OTA 실제 적용 허용",
    syncProviderApplyHintStation: "스테이션 실제 적용 허용",
    syncProviderApplyHintNaver: "네이버 실제 적용 허용",
    syncSaveCfg: "설정 저장",
    syncFeatureOn: "실제 적용 ON",
    syncFeatureOff: "실제 적용 OFF",
    syncRun: "OTA 캘린더 적용",
    syncRunNeedApprove: "OTA 캘린더 적용 (승인 필요)",
    syncRunProviderBlocked: "OTA 캘린더 적용 (현재 OTA 차단)",
    syncApproveTitle: "적용 전 승인",
    syncApproveMismatch: "불일치",
    syncApproveClosed: "닫음 예상",
    syncApprovePeriod: "적용 기간",
    syncApproveConfirmLabel: "영향 범위를 확인했고 실제 적용을 진행합니다.",
    syncResult: "결과 요약",
    syncBlockedTitle: "적용 차단 사유",
    resultTotal: "변환 총 건",
    resultSuccess: "성공 건",
    resultFail: "실패 건",
    resultClosed: "닫음 처리건",
    ...
    errorType: "유형",
    errorDetail: "내용",
    statusSyncing: "동기화 적용 중...",
    statusSyncSaved: "설정이 저장되었습니다.",
    statusSyncDone: "동기화 적용 완료",
    statusSyncNoDiff: "불일치 항목이 없어 적용할 내용이 없습니다.",
    statusSyncNeedLoadBeforeRun: "API 호출 최소화를 위해 동기화 전 '사이트+시트 조회'를 먼저 실행하세요.",
    statusSyncVerifyByManualLoad: "적용 후 검증은 자동 재조회 없이 조회 버튼으로 확인합니다.",
    statusSyncSavedNeedReload: "설정 저장 완료. 반영은 다음 조회 시 적용됩니다.",
    statusSyncFeatureEnabled: "실제 적용 모드가 켜졌습니다.",
    statusSyncFeatureDisabled: "실제 적용 모드가 꺼졌습니다.",
    statusAuthBundleCaptured: "현재 사이트 인증 번들을 채웠습니다. 저장 후 재실행하면 세션을 다시 주입합니다.",
    statusAuthBundleCopied: "현재 사이트 인증 번들을 복사했습니다.",
    statusSyncApplySkipped: "실제 적용 모드가 꺼져 있어 미리보기만 갱신했습니다.",
    statusNeedSyncApproval: "적용 전 승인 체크가 필요합니다.",
