...
STATION_HAR="${STATION_HAR:-/mnt/c/Users/anise/OneDrive/바탕 화면/admin.admin-stationbyuhc.com Gangnam.har}"
PMS_HAR="${PMS_HAR:-/mnt/c/Users/anise/OneDrive/바탕 화면/pms.sanhait.com.ACCOUNT gangnam.har}"
